...
// var oldUpperLeft   = []; //upper left in pixels  Needed for scaling and transforming later. 
// var oldBottomRight = [];//bottom right ""
...
var brightness = d3.scale.linear() //Gold = more sunlight
